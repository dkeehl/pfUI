pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- GUI Frame
    ...
    pfUI.gui.title:SetFont(pfUI.media["font:Hooge.ttf"], 12)
    ...
    pfUI.gui.version:SetFont(pfUI.media["font:Myriad-Pro.ttf"], 12)
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Settings"], T["General"], function()
      ...
      CreateConfig(nil, T["Quest Text Font"], C.global, "font_quest", "dropdown", pfUI.gui.dropdowns.fonts)
      CreateConfig(nil, T["Chat Font"], C.global, "font_chat", "dropdown", pfUI.gui.dropdowns.fonts)
